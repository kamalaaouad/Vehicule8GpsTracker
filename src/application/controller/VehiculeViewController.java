...
public class VehiculeViewController implements Initializable {
	...
	public void onAddVehicule(ActionEvent event) throws NamingException {
		if(tfIdV.getText().equals("") && tfMarqueV.getText() !="" && tfMatriculeV.getText() !="" && tfTypeV.getText()!="") {
			IVehiculeRemote vehicule = lookUpVehiculeRemote();
			vehicule.create(new Vehicule(tfMatriculeV.getText(),tfMarqueV.getText(),tfTypeV.getText()));
			loadDate();
	...
	public void onUpDateVehicule(ActionEvent event) throws NamingException {
		if(tfIdV.getText()!="" && tfMarqueV.getText()!="" && tfMatriculeV.getText()!="" && tfTypeV.getText()!="") {
		IVehiculeRemote vehicule = lookUpVehiculeRemote();
		vehicule.update(new Vehicule(Long.parseLong(tfIdV.getText()),tfMatriculeV.getText(),tfMarqueV.getText(),tfTypeV.getText()));
		loadDate();
		tfIdV.setText("");
		tfMatriculeV.setText("");
		tfMarqueV.setText("");
	...
	public void onDeleteVehicule(ActionEvent event) throws NamingException {
		if(tfIdV.getText()!="" && tfMarqueV.getText()!="" && tfMatriculeV.getText()!="" && tfTypeV.getText()!="") {
			IVehiculeRemote vehicule = lookUpVehiculeRemote();
			vehicule.delete(new Vehicule(Long.parseLong(tfIdV.getText()),tfMatriculeV.getText(),tfMarqueV.getText(),tfTypeV.getText()));
			loadDate();
			tfIdV.setText("");
			tfMatriculeV.setText("");
			tfMarqueV.setText("");
